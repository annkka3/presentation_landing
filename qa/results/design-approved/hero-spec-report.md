...
| Mobile artifact | width 382px; top 98.59375px; right -140px inside stack | width 297px; top 206.59375px; right -112px | PASS |
| Commerce block | polished top anchor inside stack | top 49.5px; box 633.59375×504.1875px | PASS |
| Brand block | polished responsive anchor | bottom 36px; height 190.265625px | PASS |
...
- Mobile artifact: left=1165, top=254.59375, right=-22, bottom=117.6875, width=297, height=527.71875, maxWidth=none, fontSize=16px, lineHeight=normal, overflow=visible, background=rgba(0, 0, 0, 0), objectPosition=50% 50%
...
- Brand block: left=716.40625, top=631.734375, right=90, bottom=78, width=633.59375, height=190.265625, maxWidth=none, fontSize=16px, lineHeight=normal, overflow=visible, background=rgba(0, 0, 0, 0), objectPosition=50% 50%
