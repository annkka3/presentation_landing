...
`
  ...
  expect(geometry.mobile).toMatchObject({ width: 297 })
  expect(relative).toEqual({ mobileTop: 206.59375, mobileRight: -112, commerceTop: 49.5, brandBottom: 36 })
  expect(geometry.brand).toMatchObject({ height: 190.265625 })
