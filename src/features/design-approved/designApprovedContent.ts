...
export const DESIGN_APPROVED_CHAPTERS: readonly DesignApprovedChapter[] = [
  ...
  { id: 'design-brand-systems', label: { ru: 'EUFashion', en: 'EUFashion' } },
  { id: 'design-maison-noiree', label: { ru: 'Maison Noiree', en: 'Maison Noiree' } },
  { id: 'design-portfolio', label: { ru: 'Портфолио', en: 'Portfolio' } },
