...
describe('homepage editorial chapters', () => {
  ...
  it('renders the purpose-built mobile chapter track and compact controls', () => {
    ...
    expect(document.querySelectorAll('.mobile-hero-strip img')).toHaveLength(4)
    ...
    expect(document.querySelectorAll('#process .mobile-process-list button')).toHaveLength(5)
